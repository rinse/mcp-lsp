...
describe('MCPToolCodeAction', () => {
  ...
  describe('handle', () => {
    ...
    it('should throw error for invalid parameters', async () => {
      ...
      await expect(mcpToolCodeAction.handle(invalidParams)).rejects.toThrow('Invalid parameters for list_available_code_actions tool');
    });
    ...
    it('should throw error when missing required parameters', async () => {
      ...
      await expect(mcpToolCodeAction.handle(missingParams)).rejects.toThrow('Invalid parameters for list_available_code_actions tool');
    });
  ...
  describe('listItem', () => {
    it('should return correct tool definition', () => {
      ...
      expect(toolDefinition.name).toBe('list_available_code_actions');
